        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('transaksi.index') }}"
                    ...
                    <svg class="w-5 h-5 transition duration-75 {{ request()->routeIs('transaksi.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('akun.index') }}"
                    ...
                    <svg class="w-5 h-5 transition duration-75 {{ request()->routeIs('akun.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('laporan.index') }}"
                    ...
                    <svg class="w-5 h-5 transition duration-75 {{ request()->routeIs('laporan.*') ? 'text-blue-600' : 'text-gray-400 group-hover:text-blue-600' }}"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
